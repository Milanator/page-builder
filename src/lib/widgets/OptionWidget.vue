...
<template>
  ...
  <div v-if="isExpanded" class="bcpb:fixed bcpb:inset-0 bcpb:bg-black/40 bcpb:backdrop-blur-sm bcpb:z-40" role="button"
  ...
  <div
    ...
    <!-- Label Section -->
    <div class="bcpb:flex bcpb:items-center bcpb:justify-between bcpb:text-sm bcpb:font-medium bcpb:text-gray-700"
      :class="{
      ...
      <!-- Expand Icon -->
      <button v-if="isExpandable" @click="toggleExpand"
    ...
    <!-- Control Section -->
    <div class="bcpb:transition-all bcpb:duration-300 bcpb:ease-in-out" :class="{
      ...
      <div v-if="isExpanded"
        class="bcpb:flex bcpb:items-center bcpb:justify-between bcpb:px-4 bcpb:border-b bcpb:border-gray-100 bcpb:bg-gray-50/50">
